...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post user_profiles_url, params: { user_profile: { bio: @user_profile.bio, experience: @user_profile.experience, name: @user_profile.name, phone: @user_profile.phone, user_id: @user_profile.user_id } }
    end
  ...
  test "should update user_profile" do
    patch user_profile_url(@user_profile), params: { user_profile: { bio: @user_profile.bio, experience: @user_profile.experience, name: @user_profile.name, phone: @user_profile.phone, user_id: @user_profile.user_id } }
